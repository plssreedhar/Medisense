...
public class SummarizationAgent {
    ...
    public SummarizationAgent(ChatClient.Builder chatClientBuilder,
                              ResourceLoader resourceLoader,
                              @Value("${prompts.summarization}") String promptPath) throws IOException {
    ...
    public String summarize(String extractedJson) {
        return chatClient.prompt().user(extractedJson).call().content();
    }
}
